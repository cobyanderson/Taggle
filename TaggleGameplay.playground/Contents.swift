...
class Game {
    ...
    var player4: String?
    var players: [String] = []
    var whoseTurn: String? = "empty"
    var playNumber: Int = 0
    var playerCount: Int = 0
    var errorMessage: String = "Unexpected Error"
    
    init (playerCount: Int, possiblePlayer1: String?, possiblePlayer2 : String?, possiblePlayer3: String?, possiblePlayer4: String?) {
        self.playerCount = playerCount
        self.playNumber = 0
        
        if let possiblePlayer1 = possiblePlayer1 {
            player1 = possiblePlayer1
        }
        self.whoseTurn = possiblePlayer1
    ...
    func quit (errorMessage: String) {
        println("Quit: " + errorMessage)
    
    
    }

}
var mygame = Game(playerCount: 3, possiblePlayer1: "Coby", possiblePlayer2: "Eugene", possiblePlayer3: "nobody",possiblePlayer4: nil)
mygame.PrintPlayers()
mygame.quit("I felt like it")
